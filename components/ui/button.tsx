  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-11 uppercase",
  {
    variants: {
      variant: {
        ...
        defaultOutline: 'bg-transparent text-slate-500 dark:text-slate-200 hover:bg-slate-100',
        primary: 'bg-sky-400 text-primary-foreground border-sky-500 border-2 border-b-4 active:border-b-0 hover:bg-sky-400/90',
        primaryOutline: 'bg-white text-sky-500 dark:text-sky-200 hover:bg-slate-100',
        secondary: 'bg-green-500 text-nuetral-300 border-green-600 border-2 border-b-4 active:border-b-0 hover:bg-green-500/90',
        ...
        sidebar: 'bg-transparent text-slate-500 dark:text-slate-400 border-2 border-transparent hover:bg-slate-100 transition-none',
        sidebarOutline: 'bg-sky-500/15 text-sky-500 dark:bg-sky-200/15 dark:text-sky-200 border-sky-300 border-2 hover:bg-sky-500/25 transition-none',
      },
      size: {
